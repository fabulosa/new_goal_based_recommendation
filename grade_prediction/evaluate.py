...
def evaluate_loss(model, loader, vali_data, batchsize, dim_input_course, dim_input_grade):

    model.eval()
    summ = []
    for step, (batch_x, batch_y) in enumerate(loader):  # batch_x: index of batch data
        processed_data = process_data(batch_x.numpy(), vali_data, batchsize, dim_input_course, dim_input_grade)
...
# for validation
def evaluate_metrics(model, loader, vali_data, batchsize, dim_input_course, dim_input_grade):
...
if __name__ == '__main__':
    ...
    evaluate_metrics(model, vali_loader, vali_data, batchsize, dim_input_course, dim_input_grade)
